...
public class MyMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        this.setFieldValByName("createUser", "xuzhif", metaObject);
        this.setFieldValByName("updateUser", "xuzhif", metaObject);
        this.setFieldValByName("studyWordCount",0,metaObject);
    }
