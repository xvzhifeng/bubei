...
public class FileController {
    ...
    @ResponseBody
    public String getMp3(String url,String name) throws FileNotFoundException {
        String projectPath = System.getProperty("user.dir") + "/upload/voice/"+name+".mp3";
...
//        }
//        log.info(res);
        return "http://api.sumu.today:10111/upload/voice/"+name+".mp3";
    }
